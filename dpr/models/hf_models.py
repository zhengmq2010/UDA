...
def get_bert_tensorizer(cfg):
    ...
    return BertTensorizer(tokenizer, cfg.encoder.sequence_length_q), BertTensorizer(tokenizer, cfg.encoder.sequence_length_ctx)
...
def get_bert_tokenizer(pretrained_cfg_name: str, do_lower_case: bool = True):
    ...
    return BertTokenizer.from_pretrained('/root/.cache/huggingface/bert-base-uncased/transformer_auto/', do_lower_case=do_lower_case)
...
class HFBertEncoder(BertModel):
    ...
    def init_encoder(
        ...
        cfg = BertConfig.from_pretrained("/root/.cache/huggingface/bert-base-uncased/transformer_auto/")
        if dropout != 0:
        ...
        if pretrained:
            ...
            return cls.from_pretrained("/root/.cache/huggingface/bert-base-uncased/transformer_auto/", config=cfg, project_dim=projection_dim, **kwargs)
        else:
